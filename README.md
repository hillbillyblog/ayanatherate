...
- 🤹 Skills/Tools/Technologies in brief: Python, Machine Learning/Deep Learning, Applied Statistics, Statistical Data Analysis, Cloud Basics (AWS, Heroku, Streamlit), PySpark, SQL (MySQL,Postgre, Oracle), MS Power BI, Web Development (HTML/CSS/JS)
